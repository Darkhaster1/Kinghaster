...
module.exports = {
    VERSION: 'v7.3.6',
    CHANNEL: 'https://chat.whatsapp.com/JVmXpPOHb705XSNFWOy8rG',
    SESSION: process.env.ASENA_SESSION === undefined ? '' : process.env.ASENA_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    THERI_KICK: process.env.BAD_KICK === undefined ? 'false' : process.env.BAD_KICK,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '94712183124@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    PLKS: process.env.BAD_LIST === undefined ? false : process.env.BAD_LIST,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    MAHN: process.env.MAAN === undefined ? '94*********,0' : process.env.MAAN, //dont change thise , if you change this some plugins created by me might not work for others or might have error ( bcoz this is a api key )
    BRANCH: 'master',
    HEROKU: {
